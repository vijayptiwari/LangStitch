...
@app.get("/api/health")
def health():
    """Platform health including node-count (cycles 76, 196, 256, 316, 376, 436, 496, 556, 616, 676, 736)."""
    return {
        "status": "ok",
...
def openapi_description():
    """OpenAPI-style schema describing platform export endpoints (cycles 232, 292, 352, 412, 472, 532, 592, 652, 712, 772)."""
    return {
        "openapi": "3.0.3",
        "info": {
...
async def export_project_preflight():
    """CORS preflight for browser cross-origin export requests (cycles 124, 244, 304, 364, 424, 484, 544, 604, 664, 724)."""

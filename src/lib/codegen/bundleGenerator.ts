...
export function buildExportBundle(
  ...
  const files: Record<string, string> = {
    ...
    '.gitignore': `target/\n__pycache__/\n.venv/\n*.pyc\n.env\n.idea/\n`,
    'README.md': `# ${doc.name}\n\nGenerated by [LangStitch](https://github.com/langstitch/langstitch).\n\n## Run locally\n\n\`\`\`bash\ndocker compose up --build\n\`\`\`\n\n- Python graph: http://localhost:8000\n- Spring gateway: http://localhost:8080\n\n## Deploy to Kubernetes\n\n\`\`\`bash\nhelm upgrade --install ${slugify(doc.name)} ./deploy/helm/langstitch\n\`\`\`\n`,
  }

  if (format === 'python' || format === 'full') {
    Object.assign(files, generatePythonRuntimeFiles(doc, pythonCode))
  }

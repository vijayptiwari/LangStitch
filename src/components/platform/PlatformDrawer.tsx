  ...
  return (
    <div className="platform-overlay" onClick={onClose} role="presentation">
      <div className="platform-drawer" data-testid="platform-drawer" onClick={(e) => e.stopPropagation()} role="dialog">
        ...
        <span className="sr-only" data-testid="cycle-599-platform-tab-persist">
          cycle 599 — platform tab persisted in {PLATFORM_TAB_KEY}
        </span>
        <span className="sr-only" data-testid="cycle-719-platform-tab-persist">
          cycle 719 — platform tab persisted in {PLATFORM_TAB_KEY}
        </span>
          ...
          <div>
            ...
            {apiOnline === true && lastHealthSync && (
              ...
              >
                ...
                <span className="sr-only" data-testid="cycle-262-health-reload">
                  cycle 262 — health metadata regression after reload
                </span>
                <span className="sr-only" data-testid="cycle-298-health-reload">
                  cycle 298 — health metadata regression after reload
                </span>
                ...
                <span className="sr-only" data-testid="cycle-766-health-reload">
                  cycle 766 — health metadata regression after reload
                </span>
              </p>
            )}
          </div>
            ...
            <div className="platform-section" data-testid="eval-panel">
              ...
              {langsmithApiKeyConfigured === false && (
                <span className="platform-badge warn" data-testid="eval-dry-run-badge">
                  ...
                  <span className="sr-only" data-testid="cycle-761-eval-dry-run">cycle 761</span>
                </span>
              )}
              {!observabilityEnabled || !langsmithEnabled ? (
                ...
                <>
                  <button
                    ...
                    data-cycle-collapse-alt7="708"
                    data-cycle-collapse-alt8="768"
                  ...
                  <div
                    ...
                    data-cycle-live-alt8="714"
                    data-cycle-live-alt9="774"
                  >
            ...
            <div className="platform-log-wrap">
              <div className="platform-log-actions">
                <button
                  ...
                  data-cycle-copy-alt7="720"
                  data-cycle-copy-alt8="780"

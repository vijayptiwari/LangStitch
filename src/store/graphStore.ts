...
/** Zustand store for graph document, canvas state, undo/redo, and project I/O (cycles 93, 141, 237, 285, 333, 381, 429, 477, 525, 573 JSDoc). */
interface GraphStore {
   ...
   * Merges imported viewport with localStorage when the import omits viewport data (cycles 44, 140, 212, 236, 284, 332, 380, 428, 476, 524, 572).
   */
  loadProject: (payload: {
    document: GraphDocument
    nodes?: Node<StitchNodeData>[]
